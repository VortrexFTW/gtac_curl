...
class CCurlMime {
	public:
		inline CCurlMime(CURL* pCurl) : m_pCurlMime() {
...
class CCurlMimePart {
	public:
		inline CCurlMimePart(curl_mime* pCurlMime) : m_pCurlMimePart() {
...
class CCurlList {
public:
	inline CCurlList(curl_slist *pCurlList) : m_pCurlList() {
		m_pCurlList = pCurlList;
	}
...
void CCurlList::Append(const char* szName) {
	if (m_pCurlList != nullptr) {
		curl_slist_append(m_pCurlList, szName);
	}
}
...
void ModuleRegister()
{
	...
	g_CurlClass.RegisterFunction("mime", [](Galactic3D::Interfaces::INativeState* pState, int32_t argc, void* pUser) {
		...
		curl_mime* pCurlMime = curl_mime_init(pCurl);
	...
	g_CurlMimeClass.RegisterFunction("part", [](Galactic3D::Interfaces::INativeState* pState, int32_t argc, void* pUser) {
		...
		SDK::ClassValue<CCurlMimePart, g_CurlMimePartClass> Value(new CCurlMimePart(pThis->m_pCurlMime));
		return true;
	...
	g_CurlMimePartClass.RegisterFunction("data", [](Galactic3D::Interfaces::INativeState* pState, int32_t argc, void* pUser) {
		...
		auto pThis = State.CheckThis<CCurlMimePart, g_CurlMimePartClass>();
	...
	g_CurlClass.RegisterFunction("setOpt", [](Galactic3D::Interfaces::INativeState* pState, int32_t argc, void* pUser) {
		...
		switch(iOptID) {
			...
			case CURLOPT_XOAUTH2_BEARER: {
					...
					curl_easy_setopt(pCurl, (CURLoption)iOptID, pValue);
				}
				break;
	...
	*/
	...
	g_CurlClass.RegisterFunction("escape", [](Galactic3D::Interfaces::INativeState* pState, int32_t argc, void* pUser) {
		SDK_TRY;
		...
		const char* szURL = State.CheckString(0);
		
		char* szEscapedURL = curl_easy_escape(pThis->m_pCurl, szURL, sizeof(szURL));

		SDK::StringValue Value(szEscapedURL);
		State.Return(Value);
	...
	// For getInfo (curl_easy_getinfo)
	SDK::Define("CURLINFO_ACTIVESOCKET", CURLINFO_ACTIVESOCKET);
	SDK::Define("CURLINFO_APPCONNECT_TIME", CURLINFO_APPCONNECT_TIME);
	SDK::Define("CURLINFO_APPCONNECT_TIME_T", CURLINFO_APPCONNECT_TIME_T);
	SDK::Define("CURLINFO_CERTINFO", CURLINFO_CERTINFO);
	SDK::Define("CURLINFO_CONDITION_UNMET", CURLINFO_CONDITION_UNMET);
	SDK::Define("CURLINFO_CONNECT_TIME", CURLINFO_CONNECT_TIME);
	SDK::Define("CURLINFO_CONNECT_TIME_T", CURLINFO_CONNECT_TIME_T);
	SDK::Define("CURLINFO_CONTENT_LENGTH_DOWNLOAD", CURLINFO_CONTENT_LENGTH_DOWNLOAD);
	SDK::Define("CURLINFO_CONTENT_LENGTH_DOWNLOAD_T", CURLINFO_CONTENT_LENGTH_DOWNLOAD_T);
	SDK::Define("CURLINFO_CONTENT_LENGTH_UPLOAD", CURLINFO_CONTENT_LENGTH_UPLOAD);
	SDK::Define("CURLINFO_CONTENT_LENGTH_UPLOAD_T", CURLINFO_CONTENT_LENGTH_UPLOAD_T);
	SDK::Define("CURLINFO_CONTENT_TYPE", CURLINFO_CONTENT_TYPE);
	SDK::Define("CURLINFO_COOKIELIST", CURLINFO_COOKIELIST);
	//SDK::Define("CURLINFO_EFFECTIVE_METHOD", CURLINFO_EFFECTIVE_METHOD);
	SDK::Define("CURLINFO_EFFECTIVE_URL", CURLINFO_EFFECTIVE_URL);
	SDK::Define("CURLINFO_FILETIME", CURLINFO_FILETIME);
	SDK::Define("CURLINFO_FILETIME_T", CURLINFO_FILETIME_T);
	SDK::Define("CURLINFO_FTP_ENTRY_PATH", CURLINFO_FTP_ENTRY_PATH);
	SDK::Define("CURLINFO_HEADER_SIZE", CURLINFO_HEADER_SIZE);
	SDK::Define("CURLINFO_HTTPAUTH_AVAIL", CURLINFO_HTTPAUTH_AVAIL);
	SDK::Define("CURLINFO_HTTP_CONNECTCODE", CURLINFO_HTTP_CONNECTCODE);
	SDK::Define("CURLINFO_HTTP_VERSION", CURLINFO_HTTP_VERSION);
	SDK::Define("CURLINFO_LASTSOCKET", CURLINFO_LASTSOCKET);
	SDK::Define("CURLINFO_LOCAL_IP", CURLINFO_LOCAL_IP);
	SDK::Define("CURLINFO_LOCAL_PORT", CURLINFO_LOCAL_PORT);
	SDK::Define("CURLINFO_NAMELOOKUP_TIME", CURLINFO_NAMELOOKUP_TIME);
	SDK::Define("CURLINFO_NAMELOOKUP_TIME_T", CURLINFO_NAMELOOKUP_TIME_T);
	SDK::Define("CURLINFO_NUM_CONNECTS", CURLINFO_NUM_CONNECTS);
	SDK::Define("CURLINFO_OS_ERRNO", CURLINFO_OS_ERRNO);
	SDK::Define("CURLINFO_PRETRANSFER_TIME", CURLINFO_PRETRANSFER_TIME);
	SDK::Define("CURLINFO_PRETRANSFER_TIME_T", CURLINFO_PRETRANSFER_TIME_T);
	SDK::Define("CURLINFO_PRIMARY_IP", CURLINFO_PRIMARY_IP);
	SDK::Define("CURLINFO_PRIMARY_PORT", CURLINFO_PRIMARY_PORT);
	SDK::Define("CURLINFO_PRIVATE", CURLINFO_PRIVATE);
	SDK::Define("CURLINFO_PROTOCOL", CURLINFO_PROTOCOL);
	SDK::Define("CURLINFO_PROXYAUTH_AVAIL", CURLINFO_PROXYAUTH_AVAIL);
	//SDK::Define("CURLINFO_PROXY_ERROR", CURLINFO_PROXY_ERROR);
	SDK::Define("CURLINFO_PROXY_SSL_VERIFYRESULT", CURLINFO_PROXY_SSL_VERIFYRESULT);
	SDK::Define("CURLINFO_REDIRECT_COUNT", CURLINFO_REDIRECT_COUNT);
	SDK::Define("CURLINFO_REDIRECT_TIME", CURLINFO_REDIRECT_TIME);
	SDK::Define("CURLINFO_REDIRECT_TIME_T", CURLINFO_REDIRECT_TIME_T);
	SDK::Define("CURLINFO_REDIRECT_URL", CURLINFO_REDIRECT_URL);
	SDK::Define("CURLINFO_REQUEST_SIZE", CURLINFO_REQUEST_SIZE);
	SDK::Define("CURLINFO_RESPONSE_CODE", CURLINFO_RESPONSE_CODE);
	SDK::Define("CURLINFO_RETRY_AFTER", CURLINFO_RETRY_AFTER);
	SDK::Define("CURLINFO_RTSP_CLIENT_CSEQ", CURLINFO_RTSP_CLIENT_CSEQ);
	SDK::Define("CURLINFO_RTSP_CSEQ_RECV", CURLINFO_RTSP_CSEQ_RECV);
	SDK::Define("CURLINFO_RTSP_SERVER_CSEQ", CURLINFO_RTSP_SERVER_CSEQ);
	SDK::Define("CURLINFO_RTSP_SESSION_ID", CURLINFO_RTSP_SESSION_ID);
	SDK::Define("CURLINFO_SCHEME", CURLINFO_SCHEME);
	SDK::Define("CURLINFO_SIZE_DOWNLOAD", CURLINFO_SIZE_DOWNLOAD);
	SDK::Define("CURLINFO_SIZE_DOWNLOAD_T", CURLINFO_SIZE_DOWNLOAD_T);
	SDK::Define("CURLINFO_SIZE_UPLOAD", CURLINFO_SIZE_UPLOAD);
	SDK::Define("CURLINFO_SIZE_UPLOAD_T", CURLINFO_SIZE_UPLOAD_T);
	SDK::Define("CURLINFO_SPEED_DOWNLOAD", CURLINFO_SPEED_DOWNLOAD);
	SDK::Define("CURLINFO_SPEED_DOWNLOAD_T", CURLINFO_SPEED_DOWNLOAD_T);
	SDK::Define("CURLINFO_SPEED_UPLOAD", CURLINFO_SPEED_UPLOAD);
	SDK::Define("CURLINFO_SPEED_UPLOAD_T", CURLINFO_SPEED_UPLOAD_T);
	SDK::Define("CURLINFO_SSL_ENGINES", CURLINFO_SSL_ENGINES);
	SDK::Define("CURLINFO_SSL_VERIFYRESULT", CURLINFO_SSL_VERIFYRESULT);
	SDK::Define("CURLINFO_STARTTRANSFER_TIME", CURLINFO_STARTTRANSFER_TIME);
	SDK::Define("CURLINFO_STARTTRANSFER_TIME_T", CURLINFO_STARTTRANSFER_TIME_T);
	SDK::Define("CURLINFO_TLS_SESSION", CURLINFO_TLS_SESSION);
	SDK::Define("CURLINFO_TLS_SSL_PTR", CURLINFO_TLS_SSL_PTR);
	SDK::Define("CURLINFO_TOTAL_TIME", CURLINFO_TOTAL_TIME);
	SDK::Define("CURLINFO_TOTAL_TIME_T", CURLINFO_TOTAL_TIME_T);	
}
